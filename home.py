    ...
    with ui.column().classes("w-full items-center bg-white py-20 px-4"):
        ...
        with ui.column().classes("w-full max-w-6xl mx-auto items-center mb-16"):
            ...
            ui.label("Welcome to FixMyCity").classes(
                "text-5xl text-sky-500 font-bold tracking-tight text-center mb-12"
            )
            ...
            with ui.row().classes("w-full items-center m-0 p-0 gap-0"):
                ...
                with ui.column().classes("w-1/2 justify-center items-center p-10"):
                    ui.label(
                        "FixMyCity is a platform that allows citizens to report civic issues in their communities — such as sanitation problems, potholes, broken infrastructure, or public safety concerns. Your reports are forwarded to the appropriate authorities for quick action, helping create cleaner, safer, and more sustainable cities in Ghana."
                    ).classes("text-xl text-gray-600 leading-relaxed")

        # Services Section
        ui.label("HOW IT WORKS").classes(
            "text-lg text-orange-500 font-serif tracking-widest"
        )
        ui.label("A Simple Process for Change").classes(
            "text-4xl text-sky-500 font-bold mb-8"
        )
        ...
        with ui.row().classes("w-full justify-center gap-8"):
            ...
            with ui.card().classes(
                ...
                "background-image: url('https://placehold.co/600x400/0ea5e9/white?text=Report'); background-size: cover; background-position: center;"
            ):
            ...
            with ui.card().classes(
                ...
                "background-image: url('https://placehold.co/600x400/0ea5e9/white?text=Investigate'); background-size: cover; background-position: center;"
            ):
                ui.element("div").classes(
                    "absolute inset-0 bg-gradient-to-t from-black via-black/70 to-transparent"
                )
            ...
            with ui.card().classes(
                ...
                "background-image: url('https://placehold.co/600x400/0ea5e9/white?text=Fixed'); background-size: cover; background-position: center;"
            ):
                ui.element("div").classes(
                    "absolute inset-0 bg-gradient-to-t from-black via-black/70 to-transparent"
                )
        ...
        with ui.column().classes("w-full items-center pt-20 pb-24 px-4 bg-white"):
            ...
            ui.label("What Our Citizens Say").classes(
                "text-4xl text-sky-500 font-bold mb-12 text-center"
            )
            ...
            with ui.row().classes("w-full justify-center items-stretch gap-8"):
                ...
                with ui.card().classes("w-96"):
                    ...
                    with ui.card_section():
                        ...
                        ui.button("Read More").props("flat color=sky-800")
        ...
        with ui.column().classes("w-full items-center pt-20 pb-24 px-4 bg-white"):
            ...
            with ui.column().classes("w-full max-w-4xl gap-6"):
                ...
                with ui.row().classes(
                    ...
                    with ui.column().classes(
                        "items-center text-center bg-sky-50 p-4 rounded-lg mr-6"
                    ):
                        ui.label("JUL").classes("text-lg font-bold text-sky-800")
                        ui.label("25").classes("text-4xl font-bold text-sky-800")
                    with ui.column().classes("flex-grow"):
                        ui.label("Osu Community Cleanup Day").classes(
                            "text-2xl font-bold"
                        )
                        ui.label("Oxford Street, Osu, Accra").classes("text-gray-600")
                    ui.button("Volunteer").props("color=sky-800")
                ...
                with ui.row().classes(
                    ...
                    with ui.column().classes(
                        ...
                        ui.label("AUG").classes("text-lg font-bold text-sky-800")
                        ui.label("15").classes("text-4xl font-bold text-sky-800")
                    with ui.column().classes("flex-grow"):
                        ui.label("Town Hall Meeting on Public Safety").classes(
                            "text-2xl font-bold"
                        )
                        ui.label("Online via Zoom").classes("text-gray-600")
                    ui.button("Join Meeting").props("color=sky-800")
                ...
                with ui.row().classes(
                    ...
                    with ui.column().classes(
                        ...
                        ui.label("SEP").classes("text-lg font-bold text-sky-800")
                        ui.label("05").classes("text-4xl font-bold text-sky-800")
                    with ui.column().classes("flex-grow"):
                        ui.label("Neighborhood Watch Training").classes(
                            "text-2xl font-bold"
                        )
                        ui.label("East Legon Police Station").classes("text-gray-600")
                    ui.button("Register").props("color=sky-800")
        ...
        with ui.column().classes("w-full items-center pt-20 pb-24 px-4 bg-gray-50"):
            ...
            ui.label("Working With Authorities & NGOs").classes(
                "text-4xl text-sky-500 font-bold mb-12 text-center"
            )
            ...
            with ui.row().classes("w-full max-w-5xl justify-center gap-x-16 gap-y-8"):
                ...
                with ui.column().classes("gap-4 items-center"):
                    ui.label("Government Authorities").classes(
                ...
                # Column for NGO Partners
                with ui.column().classes("gap-4 items-center"):
                    ui.label("NGO Partners").classes(
                        "text-2xl font-bold text-gray-800 mb-2"
                    )
                    for ngo in [
                        ...
                        ui.label(ngo).classes("text-lg text-gray-600")
